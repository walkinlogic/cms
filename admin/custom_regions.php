<?php 
	...
	if(isset($_GET['args1'])){
		...
		$mysql->record_delete("customregion_tbl","id = $args1");
	}
	?>
...
<body>
	<div class="wrap">
		...
		<div class="container">
			<h2>Custom Regions Management</h2>
			<div class="rightbtn">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tbl">
				  ...
				  <?php 
					$i=1;
					$tbl_name="customregion_tbl";		//your table name
					...
					<td><a href="new_region.php?args1=<?php echo $postrow['id']; ?>"><img src="images/edituser.png" border="0" alt="edit user" title="Edit" /></a></td>
			...
			<div class="addbtn-right">
				<a href="new_region.php" title="Add New"><input name="add" id="add" border="0" type="submit" value="Add New" class="addpagebtn" /></a> 
			</div>
		</div>
