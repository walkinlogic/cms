<?php 
	...
	if(isset($_GET['args1'])){
		...
		$mysql->record_delete("staff_tbl","id = $args1");
	}
	?>
	...
	<div class="wrap">
		...
		<div class="container">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tbl">
				  <tr class="headerbar">
					<th width="29%" class="alignleft">Staff Name</th>
				  ...
				  <?php 
					$i=1;
					$tbl_name="staff_tbl";		// staff_tbl customimages_tbl your table name
					...
					<td><a href="new_staff.php?args1=<?php echo $postrow['id']; ?>"><img src="images/edituser.png" border="0" alt="edit user" title="Edit" /></a></td>
					<td><a href="staff.php?args1=<?php echo $postrow['id']; ?>" onclick="return confirm('Do you want to delete this?');"><img src="images/delete.png" border="0" title="Delete" alt="delete user" /></a></td>
			...
			<div class="addbtn-right">
				<a href="new_staff.php" title="Add New"><input name="add" id="add" border="0" type="submit" value="Add New" class="addpagebtn" /></a> 
			</div>
		</div>
