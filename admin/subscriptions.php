<?php 
	...
	if(isset($_GET['args1'])){
		...
		$mysql->record_update("subscription_tbl",array('status' => $args2),"id=$args1");
		//print_r($check);
	}	
	if(isset($_GET['args3'])){
		$args3 =cleaninputfield($mysql,$_GET['args3']);
		$mysql->record_delete("subscription_tbl","id = $args3");
	}
	?>
	...
	<div class="wrap">
		...
		<div class="container">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tbl">
				  <tr class="headerbar">
					<th width="36%" class="alignleft">Email</th>
				  ...
				  <?php 
					$i=1;
					$tbl_name="subscription_tbl";		//your table name
					...
					/* Get data. */
					$postrows = $mysql->list_table("$tbl_name",false, array ('range' => '*','limitOffset'=>$start,'rowCount'=>$limit,'sortColumn'=>"sub_date",'sortType'=>'DESC'));
					...
					<td class="alignleft"><?php echo $postrow['sub_date']; ?></td>
					<td align="left">
					<?php 
						$status=$postrow['status'];
						if($status == 1){ 
							echo "<a href='subscriptions.php?args1=$postrow[id]&args2=0'> &nbsp; &nbsp; <img src='images/active.png' border='0' alt='active' /> Active &nbsp; &nbsp;</a>";
						}else{ 
							echo "<a href='subscriptions.php?args1=$postrow[id]&args2=1'> &nbsp; &nbsp; <img src='images/hidden.png' border='0' alt='hidden' /> Inactive</a>";
						}	
						?>						</td>
					 <td><a href="subscriptions.php?args3=<?php echo $postrow['id']; ?>" onclick="return confirm('Do you want to delete this?');"><img src="images/delete.png" border="0" title="Delete" alt="delete" /></a></td>
				  </tr>
				  <?php 
				  		$i++;
				  		} ?>
