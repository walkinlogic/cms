<?php 
	...
	if(isset($_GET['args1'])){
		...
		$mysql->record_update("d_collections_tbl",array('status' => $args2),"id=$args1");
	}	
	if(isset($_GET['args3'])){
		$args3 = cleaninputfield($mysql,$_GET['args3']);
		$mysql->record_delete("d_collections_tbl","id = $args3");
	}
	?>
...
<body>
	<div class="wrap">
		...
		<div class="container">
			<h2>Decorative Collections Management </h2>
			<div class="rightbtn">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tbl">
				  <tr class="headerbar">
					<th width="25%" class="alignleft">Name</th>
					<th width="28%" class="alignleft">Sort Order </th>
				  ...
				  <?php 
					$i=1;
					$tbl_name="d_collections_tbl";		//your table name
					...
					/* Get data. */
					$postrows = $mysql->list_table("$tbl_name",false, array ('range' => '*','limitOffset'=>$start,'rowCount'=>$limit,'sortColumn'=>"sort_order",'sortType'=>'ASC'));
				  ...
				  <tr>
					<td class="alignleft"><?php echo stripslashes($postrow['name']); ?></td>
					<td class="alignleft"><?php echo $postrow['sort_order']; ?></td>
					<td align="left">
					<?php 
						$status=$postrow['status'];
						if($status == 1){ 
							echo "<a href='d-collections_list.php?args1=$postrow[id]&args2=0'> &nbsp; &nbsp; <img src='images/active.png' border='0' alt='active' /> Active &nbsp; &nbsp;</a>";
						}else{ 
							echo "<a href='d-collections_list.php?args1=$postrow[id]&args2=1'> &nbsp; &nbsp; <img src='images/hidden.png' border='0' alt='hidden' /> Inactive</a>";
						}	
						?>						</td>
					<td><a href="new_d-collection.php?args1=<?php echo $postrow['id']; ?>"><img src="images/edituser.png" border="0" alt="edit" title="Edit" /></a></td>
					<td><a href="d-collections_list.php?args3=<?php echo $postrow['id']; ?>" onclick="return confirm('Do you want to delete this?');"><img src="images/delete.png" border="0" title="Delete" alt="delete" /></a></td>
				  </tr>
				  <?php 
				  		$i++;
				  		} ?>
			...
			<!--<a class="addpagebtn_link" title="Add New" href="new_d-collection.php">Add New</a>-->
			<div class="addbtn-right">
				<a href="new_d-collection.php" title="Add New"><input name="add" id="add" border="0" type="submit" value="Add New" class="addpagebtn" /></a> 
			</div>
		</div>
