<?php 
	...
	if(isset($_GET['args1'])){
		...
		$mysql->record_delete("downloads_tbl","id = $args1");
	}
	?> 
	...
	<div class="wrap">
		...
		<div class="container">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tbl">
				  ...
				  <?php 
					$i=1;
					$tbl_name="downloads_tbl";		//your table name
					...
					<td>
						<a href="new_download.php?args1=<?php echo $postrow['id']; ?>"><img src="images/edituser.png" border="0" alt="edit user" title="Edit" /></a>
						<a href="downloads.php?args1=<?php echo $postrow['id']; ?>"><img src="images/delete.png" border="0" alt="Delete user" title="Delete" /></a>
					</td>
			...
			<div class="addbtn-right">
				<a href="new_download.php" title="Add New"><input name="add" id="add" border="0" type="submit" value="Add New" class="addpagebtn" /></a> 
			</div>
		</div>
