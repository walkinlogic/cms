<?php 
	...
	if(isset($_GET['args1'])){
		...
		$mysql->record_update("retail_locations_tbl",array('status' => $args2),"id=$args1");
		//print_r($check);
	}	
	if(isset($_GET['args3'])){
		$args3 =cleaninputfield($mysql,$_GET['args3']);
		$mysql->record_delete("retail_locations_tbl","id = $args3");
	}
	?>
...
<body>
	<div class="wrap">
		...
		<div class="container">
			<h2>Retail Locations Management</h2>
			<div class="rightbtn">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tbl">
				  <tr class="headerbar">
					<th width="36%" class="alignleft">Name</th>
					<th width="22%" class="alignleft">Address</th>
					<th width="14%">Status</th>
					<th width="14%">Edit News </th>
					<th width="14%">Delete News </th>
				  </tr>
				  <?php  
					$i=1;
					$tbl_name="retail_locations_tbl";		//your table name
					...
					/* Get data. */
					$postrows = $mysql->list_table("$tbl_name",false, array ('range' => '*','limitOffset'=>$start,'rowCount'=>$limit,'sortColumn'=>"name",'sortType'=>'ASC'));
					...
					<td class="alignleft"><?php echo $postrow['name']; ?></td>
					<td class="alignleft"><?php echo $postrow['address']; ?></td>
					<td align="left">
					<?php 
						$status=$postrow['status'];
						if($status == 1){ 
							echo "<a href='retail_locations_list.php?args1=$postrow[id]&args2=0'> &nbsp; &nbsp; <img src='images/active.png' border='0' alt='active' /> Active &nbsp; &nbsp;</a>";
						}else{ 
							echo "<a href='retail_locations_list.php?args1=$postrow[id]&args2=1'> &nbsp; &nbsp; <img src='images/hidden.png' border='0' alt='hidden' /> Inactive</a>";
						}	
						?>						</td>
					<td><a href="new_retail_location.php?args1=<?php echo $postrow['id']; ?>"><img src="images/edituser.png" border="0" alt="edit user" title="Edit" /></a></td>
					<td><a href="retail_locations_list.php?args3=<?php echo $postrow['id']; ?>" onclick="return confirm('Do you want to delete this?');"><img src="images/delete.png" border="0" title="Delete" alt="delete user" /></a></td>
				  </tr>
				  <?php 
				  		$i++;
				  		} ?>
			...
			<div class="addbtn-right">
				<a href="new_retail_location.php" title="Add Location"><input name="add" id="add" border="0" type="submit" value="Add Location" class="addpagebtn" /></a> 
			</div>
		</div>
