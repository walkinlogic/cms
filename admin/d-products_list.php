<?php 
	...
	if(isset($_GET['args1'])){
		...
		$mysql->record_update("d_products_tbl",array('status' => $args2),"id=$args1");
		//print_r($check);
	}	
	if(isset($_GET['sortorder'])){
		$sortorder = cleaninputfield($mysql,$_GET['sortorder']);
		$id = cleaninputfield($mysql,$_GET['id']);
		$mysql->record_update("d_products_tbl",array('sort_order' => $sortorder),"id=$id");
		//print_r($check);
	}	
	
	if(isset($_GET['args3'])){
		$args3 = cleaninputfield($mysql,$_GET['args3']);
		$mysql->record_delete("d_products_tbl","id = $args3");
	}
	?>
...
<body>
	<div class="wrap">
		...
		<div class="container">
			<h2>Decorative Products Management </h2>
			<div class="rightbtn">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tbl">
				  ...
				  <?php 
					$i=1;
					$tbl_name="d_products_tbl";		//your table name
					...
					if($lastpage > 1){	
					 ...
					 function getDCollection($args1,$obj){
						  $rec = $obj->fetch_row("d_collections_tbl","id=$args1");
				  ...
				  <tr>
					...
					<td class="alignleft"><?php echo getDCollection($postrow['collection_id'],$mysql); ?></td>
					<td class="aligncenter">
					<a href='d-products_list.php?id=<?php echo $postrow[id].'&sortorder='.($postrow['sort_order']-1); ?>' title='Move Up'><img src='images/up-arrow.png' title='Move Up'/></a>
					<?php echo $postrow['sort_order']; ?>
					<a href='d-products_list.php?id=<?php echo $postrow[id].'&sortorder='.($postrow['sort_order']+1); ?>' title='Move Down'><img src='images/down-arrow.png' title='Move Down'/></a>
					</td>
					<td align="left">
					<?php 
						$status=$postrow['status'];
						if($status == 1){ 
							echo "<a href='d-products_list.php?args1=$postrow[id]&args2=0'> &nbsp; &nbsp; <img src='images/active.png' border='0' alt='active' /> Active &nbsp; &nbsp;</a>";
						}else{ 
							echo "<a href='d-products_list.php?args1=$postrow[id]&args2=1'> &nbsp; &nbsp; <img src='images/hidden.png' border='0' alt='hidden' /> Inactive</a>";
						}	
						?>						</td>
					<td><a href="d-product_gallery.php?product_id=<?php echo $postrow['id']; ?>"><img src="images/editsetting.png" border="0" alt="edit" title="Edit" /></a></td>
					<td><a href="new_d-product.php?args1=<?php echo $postrow['id']; ?>"><img src="images/edituser.png" border="0" alt="edit" title="Edit" /> <a href="d-products_list.php?args3=<?php echo $postrow['id']; ?>" onclick="return confirm('Do you want to delete this?');"><img src="images/delete.png" border="0" title="Delete" alt="delete" /></a></td>
				  </tr>
				  <?php 
				  		$i++;
				  		} ?>
			...
			<!--<a class="addpagebtn_link" title="Add New" href="new_d-product.php">Add New</a>-->
			<div class="addbtn-right">
				<a href="new_d-product.php" title="Add New"><input name="add" id="add" border="0" type="submit" value="Add New" class="addpagebtn" /></a> 
			</div>
		</div>
