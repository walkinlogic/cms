	...
	<div class="wrap">
		...
		<div class="container">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tbl">
				  ...
				  <?php 
					$i=1;
					$tbl_name="content_tbl c INNER JOIN sitemap_tbl sm ON c.id=sm.pageid";		//your table name
					...
					/* Get data. */
					$postrows = $mysql->list_table("$tbl_name",false, array ('range' => 'c.*,sm.id as siteid,sm.sortorder as mapsortorder','limitOffset'=>$start,'rowCount'=>$limit,'sortColumn'=>"sm.sortorder",'sortType'=>'ASC'));
					...
					<td class="alignleft"><?php echo stripslashes($postrow['pagename']); ?></td>
					<td class="alignleft"><?php echo stripslashes($postrow['ar_pagename']); ?></td>
					<td class="alignleft"><?php echo $postrow['mapsortorder']; ?></td>
					<td> 
					<a href="new_sitemap.php?args1=<?php echo $postrow['siteid']; ?>">
					<img src="images/edituser.png" border="0" alt="edit user" title="Edit" /></a>
			...
			<div class="addbtn-right">
				<a href="new_sitemap.php" title="Add New"><input name="add" id="add" border="0" type="submit" value="Add New" class="addpagebtn" /></a> 
			</div>
		</div>
