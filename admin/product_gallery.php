<?php 
	...
	if(isset($_GET['args2'])){
		...
		$mysql->record_update("product_images_tbl",array('status' => $args3),"id=$args2");
		//print_r($check);
	}	
	if(isset($_GET['sortorder'])){
		$sortorder = cleaninputfield($mysql,$_GET['sortorder']);
		$id = cleaninputfield($mysql,$_GET['id']);
		$mysql->record_update("product_images_tbl",array('sortorder' => $sortorder),"id=$id");
		//print_r($check);
	}	
	...
	if(isset($_GET['args4'])){
		...
		$mysql->record_delete("product_images_tbl","id = $args4");
	}
	?>
		...
		<div class="container">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tbl">
				  ...
				  <?php 
					...
					$postrows = $mysql->list_table("product_images_tbl ",$where,array('sortColumn' => 'sortorder','sortType'=>'ASC'));
					...
					<td align="center" style="padding-top:8px">	
						<a href='product_gallery.php?id=<?php echo $postrow[id].'&sortorder='.($postrow['sortorder']-1).$args1; ?>' title='Move Up'><img src='images/up-arrow.png' title='Move Up'/></a>
						<a href='product_gallery.php?id=<?php echo $postrow[id].'&sortorder='.($postrow['sortorder']+1).$args1; ?>' title='Move Down'><img src='images/down-arrow.png' title='Move Down'/></a>
					...
					<?php  
						if($postrow['status'] == 1){ 
							echo "<a href='product_gallery.php?args2=$postrow[id]&args3=0$args1'> &nbsp; &nbsp; <img src='images/active.png' border='0' alt='active' title='Active' /></a>";
						}else{ 
							echo "<a href='product_gallery.php?args2=$postrow[id]&args3=1$args1'> &nbsp; &nbsp; <img src='images/hidden.png' border='0' alt='hidden' title='Inactive' /></a>";
						}	
						?>						
					<a href="product_image.php?args2=<?php echo $postrow['id'].$args1; ?>"><img src="images/edituser.png" border="0" alt="edit user" title="Edit" /></a>
					<a href="product_gallery.php?args4=<?php echo $postrow['id'].$args1."&args5=".$postrow['image']; ?>" onclick="return confirm('Do you want to delete this?');"><img src="images/delete.png" border="0" title="Delete" alt="delete Image" /></a></td> 
				  <?php 
				  		$i++;
				  		} 
						echo "</tr>";
			...
			<!--<a class="addpagebtn_link" title="Add Image" href="product_image.php?<?php echo $args1; ?>">Add Image</a>-->
			<div class="addbtn-right">
				<a href="product_image.php?<?php echo $args1; ?>" title="Add Image"><input name="add" id="add" border="0" type="submit" value="Add Image" class="addpagebtn" /></a> 
			</div>
		</div>
