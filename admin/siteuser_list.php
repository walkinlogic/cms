<?php 
	...
	if(isset($_GET['args1'])){
		...
		$mysql->record_update("siteuser_tbl",array('status' => $args2),"id=$args1");
		//print_r($check);
	}	
	if(isset($_GET['args3'])){
		$args3 = cleaninputfield($mysql,$_GET['args3']);
		$mysql->record_delete("siteuser_tbl","id = $args3");
	}
	?>
	...
	<div class="wrap">
		...
		<div class="container">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tbl">
				  ...
				  <tr <?php echo $row_class; ?>>
					...
					<?php 
						...
						if($status == 1){ 
							echo "<a href='siteuser_list.php?args1=$postrow[id]&args2=0'> &nbsp; &nbsp; <img src='images/active.png' border='0' alt='active' /> Active &nbsp; &nbsp;</a>";
						}else{ 
							echo "<a href='siteuser_list.php?args1=$postrow[id]&args2=1'> &nbsp; &nbsp; <img src='images/hidden.png' border='0' alt='hidden' /> Inactive  </a>";
						}	
						?>						</td>
					<td><a href="new_siteuser.php?args1=<?php echo $postrow['id']; ?>"><img src="images/edituser.png" border="0" alt="edit user" title="Edit" /></a></td>
					<td><a href="siteuser_list.php?args3=<?php echo $postrow['id']; ?>" onclick="return confirm('Do you want to delete this?');"><img src="images/delete.png" border="0" title="Delete" alt="delete user" /></a></td>
				  </tr>
				  <?php 
				  		$i++;
				  		}  ?>
			...
			<div class="addbtn-right">
				<a href="new_siteuser.php" title="Add Site User"><input name="add" id="add" border="0" type="submit" value="Add Site User" class="addpagebtn" /></a> 
			</div>
		</div>
