<?php 
	...
	if(isset($_GET['args1'])){
		...
		$image_name = getCustomImage($args1,$mysql);
		@unlink("../uploaded/$image_name");
		@unlink("../uploaded/thumbs/$image_name");
		$mysql->record_delete("certificates_tbl","id = $args1");
	}
	?>
	...
	<div class="wrap">
		...
		<div class="container">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tbl">
				  <tr class="headerbar">
					<th width="29%" class="alignleft">Title</th>
					<th width="29%" class="alignleft">Arabic</th>
					<th width="17%" class="alignleft">Sort Order</th>
					<th width="13%">Edit  </th>
				  </tr>
				  <?php 
					$i=1;
					$tbl_name="certificates_tbl";		//your table name
					...
					<td class="alignleft"><?php echo stripslashes($postrow['ar_title']); ?></td>
					<td class="alignleft"><?php echo $postrow['sortorder']; ?></td>
					<td>
						<a href="new_certificate.php?args1=<?php echo $postrow['id']; ?>"><img src="images/edituser.png" border="0" alt="edit user" title="Edit" /></a>
						<a href="certificates.php?args1=<?php echo $postrow['id']; ?>"><img src="images/delete.png" border="0" alt="Delete user" title="Delete" /></a>
					</td>
			...
			<div class="addbtn-right">
				<a href="new_certificate.php" title="Add New"><input name="add" id="add" border="0" type="submit" value="Add New" class="addpagebtn" /></a> 
			</div>
		</div>
