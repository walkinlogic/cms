<?php 
	...
	if(isset($_GET['args1'])){
		...
		$mysql->record_update("slide_show_tbl",array('status' => $args2),"id=$args1");
		//print_r($check);
	}	
	if(isset($_GET['args3'])){
		$args3 = cleaninputfield($mysql,$_GET['args3']);
		$image_name = getSlideName($args3,$mysql);
		@unlink("../uploaded/$image_name");
		@unlink("../uploaded/thumbs/$image_name");
		$mysql->record_delete("slide_show_tbl","id = $args3");
	}
	?>
		...
		<div class="container">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tbl">
				  <tr class="headerbar">
					...
					<th width="20%" class="alignleft">Page Name</th>
					<th width="19%" class="alignleft">Sort Order </th>
					<th width="14%">Status</th>
					<th width="13%">Edit Slide </th>
					<th width="15%">Delete Slide</th>
				  </tr>
				  <?php 
					$i=1;
					$tbl_name="slide_show_tbl";		//your table name
				  ...
				  <tr>
					...
					<td class="alignleft"><?php echo getPageName($postrow['pageid'],$mysql); ?></td>
					<td class="alignleft"><?php echo $postrow['sort_order']; ?></td>
					<td align="left">
					<?php 
						$status=$postrow['status'];
						if($status == 1){ 
							echo "<a href='slide_list.php?args1=$postrow[id]&args2=0'> &nbsp; &nbsp; <img src='images/active.png' border='0' alt='active' /> Active &nbsp; &nbsp;</a>";
						}else{ 
							echo "<a href='slide_list.php?args1=$postrow[id]&args2=1'> &nbsp; &nbsp; <img src='images/hidden.png' border='0' alt='hidden' /> Inactive</a>";
						}	
						?>						</td>
					<td><a href="new_slide.php?args1=<?php echo $postrow['id']; ?>"><img src="images/edituser.png" border="0" alt="edit user" title="Edit" /></a></td>
					<td><a href="slide_list.php?args3=<?php echo $postrow['id']; ?>" onclick="return confirm('Do you want to delete this?');"><img src="images/delete.png" border="0" title="Delete" alt="delete user" /></a></td>
				  </tr>
				  <?php 
				  		$i++;
				  		} ?>
			...
			<div class="addbtn-right">
				<a href="new_slide.php" title="Add Slideshow"><input name="add" id="add" border="0" type="submit" value="Add Slideshow" class="addpagebtn" /></a> 
			</div>
		</div>
